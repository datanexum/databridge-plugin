...
The plugin configures a DataBridge MCP server with **302 CE tools** (up to 367 with Pro/Enterprise) in full mode. The server starts automatically when Claude Code loads the plugin.
