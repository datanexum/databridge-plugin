...
The plugin configures a DataBridge MCP server with **287 CE tools** (up to 344 with Pro/Enterprise) in full mode. The server starts automatically when Claude Code loads the plugin.
