...
The plugin configures a DataBridge MCP server with **297 CE tools** (up to 362 with Pro/Enterprise) in full mode. The server starts automatically when Claude Code loads the plugin.
