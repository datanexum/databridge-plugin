...
The plugin configures a DataBridge MCP server with **291 CE tools** (up to 350 with Pro/Enterprise) in full mode. The server starts automatically when Claude Code loads the plugin.
